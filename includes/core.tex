...
Softvér sa bude skladať z troch hlavných služieb: generator service, relay service a auth service.
...
Pri návrhu Aplikačného rozhrania je dôležité myslieť na
...
Ochrana pred neoprávneným prístupom bude ďalej realizovaná pomocou služby gateway. Táto služba bude jediný bod ako sa dá pristúpiť do našej domény z internetu. Služba bude povoľovať len dotazy ktoré špecifikujeme. Ochrana proti neprávnenému prístupu bude taktiež realizovaná na vrstve operačného systému pomocou firewallu.
